...
class ShowPrivacyDialog {
  ...
  ShowPrivacyDialog({required this.context});
...
String get privacyPolicy {
  return """
非常歡迎您光臨「FOODIE」（以下簡稱本網站），為了讓您能夠安心使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：

<bold>一、隱私權保護政策的適用範圍</bold>
隱私權保護政策內容，包括本網站如何處理在您使用網站服務時收集到的個人識別資料。隱私權保護政策不適用於本網站以外的相關連結網站，也不適用於非本網站所委託或參與管理的人員。

<bold>二、個人資料的蒐集、處理及利用方式</bold>
...
<bold>四、網站對外的相關連結</bold>
本網站的網頁提供其他網站的網路連結，您也可經由本網站所提供的連結，點選進入其他網站。但該連結網站不適用本網站的隱私權保護政策，您必須參考該連結網站中的隱私權保護政策。

<bold>五、與第三人共用個人資料之政策</bold>
...
<bold>六、Cookie之使用</bold>
為了提供您最佳的服務，本網站會在您的電腦中放置並取用我們的Cookie，若您不願接受Cookie的寫入，您可在您使用的瀏覽器功能項中設定隱私權等級為高，即可拒絕Cookie的寫入，但可能會導至網站某些功能無法正常執行 。

<bold>七、隱私權保護政策之修正</bold>
